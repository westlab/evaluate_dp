...
def new_column_info_from_dict(conf: Dict[str, NumberType], output_int: bool = False) -> ColumnInfo:
    if output_int:
...
def new_column_info_list_from_yaml(file_name: str, output_int: bool = False) -> Dict[str, ColumnInfo]:
